    ...
    <div className="bg-dark-900 rounded-xl border border-gray-800">
      ...
      <div className="p-4 border-b border-gray-800">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              onClick={goToToday}
              className="px-4 py-2 text-sm font-medium text-primary-500 hover:text-primary-400"
            >
              Today
            </button>
            <button
      ...
      <div className="grid grid-cols-7 border-b border-gray-800">
        {["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"].map((day) => (
          <div
            key={day}
            className="p-2 text-center text-sm font-medium text-gray-500 border-r border-gray-800 last:border-r-0"
          >
            {day}
          </div>
        ))}
...
function CalendarDay({
  ...
  return (
    <div
      className={`
        min-h-[200px] p-2 border-r border-b border-gray-800
      ...
      <div className="space-y-1">
        ...
        {tasks.map((task) => (
          <div
            key={task._id}
            className={`
              p-1.5 rounded text-xs cursor-pointer truncate
        ...
        {events.map((event) => (
          <div
            key={event._id}
            className="p-1.5 rounded text-xs cursor-pointer bg-purple-500/10 text-purple-400 border border-purple-500/20 truncate"
            title={event.title}
          >
            <div className="flex items-center gap-1">
